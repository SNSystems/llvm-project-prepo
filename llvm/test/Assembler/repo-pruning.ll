...
; Step 1: Generate the repo IR code which contains the RepoDefinition metadata;
...
;CHECK: !RepoDefinition(name: "me", digest: [16 x i8] c"{{.*}}", linkage: linkonce_odr, visibility: default, pruned: false)
;CHECK: !RepoDefinition(name: "foo", digest: [16 x i8] c"{{.*}}", linkage: internal, visibility: default, pruned: true)
;CHECK: !RepoDefinition(name: "bar", digest: [16 x i8] c"{{.*}}", linkage: external, visibility: default, pruned: true)
;CHECK: !RepoDefinition(name: "c", digest: [16 x i8] c"{{.*}}", linkage: external, visibility: default, pruned: true)
