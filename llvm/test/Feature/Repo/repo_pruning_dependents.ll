...
;
; In the test, the digest of A is given in the TicketNode (as if it were generated
...
; on function C, both TicketNodes of B and C need to be added into the 'repo.tickets'
; during the pruning.
;
...
; Step 3: Remove the TicketNode metadata from the functions B and C.
; Step 4: Since the functions B and C don't have the TicketNode, the digest of functions B
...
; RUN: %python %S/Inputs/remove_GO_ticketnode.py -r B C -i %t.repo.ll -o %t.ll
