...
;CHECK-NEXT: Recording result for "A"
;CHECK-NEXT: Computing hash for "B" (#0)
;CHECK-NEXT: Recording result for "B"
;CHECK-NEXT: Computing hash for "C" (#0)
;CHECK-NEXT: Computing hash for "A" (#1)
;CHECK-NEXT: Returning pre-computed hash for "A"
;CHECK-NEXT: Computing hash for "B" (#1)
;CHECK-NEXT: Returning pre-computed hash for "B"
;CHECK-NEXT: Recording result for "C"
;
